  ...
  return (
    <div>
      ...
      <form onSubmit={handlesubmit}>
        <div style={{height:'540px',width:'560px', border:'2px solid teal', textAlign:'center', margin:'auto' ,background: 'linear-gradient(to right, rgba(275,0,3,0), rgba(228,0,0,1))'}}>
